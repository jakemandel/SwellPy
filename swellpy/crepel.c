...
extern int __pyx_module_is_main_crepel;
...
static PyObject *__pyx_pf_6crepel_iterate(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_data, __Pyx_memviewslice __pyx_v_idx, __Pyx_memviewslice __pyx_v_kick, PY_LONG_LONG __pyx_v_size); /* proto */
...
static PyMethodDef __pyx_mdef_6crepel_1iterate = {"iterate", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_6crepel_1iterate, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_6crepel_1iterate(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_memviewslice __pyx_v_kick = { 0, 0, { 0 }, { 0 }, { 0 } };
  ...
  __Pyx_RefNannySetupContext("iterate (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_idx)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("iterate", 1, 4, 4, 1); __PYX_ERR(0, 5, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_kick)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("iterate", 1, 4, 4, 2); __PYX_ERR(0, 5, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_size)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("iterate", 1, 4, 4, 3); __PYX_ERR(0, 5, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "iterate") < 0)) __PYX_ERR(0, 5, __pyx_L3_error)
      }
    ...
    __pyx_v_data = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_data.memview)) __PYX_ERR(0, 5, __pyx_L3_error)
    __pyx_v_idx = __Pyx_PyObject_to_MemoryviewSlice_ds_PY_LONG_LONG(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_idx.memview)) __PYX_ERR(0, 5, __pyx_L3_error)
    __pyx_v_kick = __Pyx_PyObject_to_MemoryviewSlice_dsdsds_double(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_kick.memview)) __PYX_ERR(0, 5, __pyx_L3_error)
    __pyx_v_size = __Pyx_PyInt_As_PY_LONG_LONG(values[3]); if (unlikely((__pyx_v_size == (PY_LONG_LONG)-1) && PyErr_Occurred())) __PYX_ERR(0, 5, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("iterate", 1, 4, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 5, __pyx_L3_error)
  __pyx_L3_error:;
...
static PyObject *__pyx_pf_6crepel_iterate(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_data, __Pyx_memviewslice __pyx_v_idx, __Pyx_memviewslice __pyx_v_kick, PY_LONG_LONG __pyx_v_size) {
  long __pyx_v_i;
  long __pyx_v_N;
 ...
 */
    ...
    __pyx_t_7 = -1;
    if (__pyx_t_4 < 0) {
      __pyx_t_4 += __pyx_v_kick.shape[0];
      if (unlikely(__pyx_t_4 < 0)) __pyx_t_7 = 0;
    } else if (unlikely(__pyx_t_4 >= __pyx_v_kick.shape[0])) __pyx_t_7 = 0;
    if (__pyx_t_5 < 0) {
      __pyx_t_5 += __pyx_v_kick.shape[1];
      if (unlikely(__pyx_t_5 < 0)) __pyx_t_7 = 1;
    } else if (unlikely(__pyx_t_5 >= __pyx_v_kick.shape[1])) __pyx_t_7 = 1;
    if (__pyx_t_6 < 0) {
      __pyx_t_6 += __pyx_v_kick.shape[2];
      if (unlikely(__pyx_t_6 < 0)) __pyx_t_7 = 2;
    } else if (unlikely(__pyx_t_6 >= __pyx_v_kick.shape[2])) __pyx_t_7 = 2;
    ...
    __pyx_t_9 = (*((PY_LONG_LONG *) ( /* dim=0 */ (__pyx_v_idx.data + __pyx_t_8 * __pyx_v_idx.strides[0]) )));
    __pyx_t_10 = 0;
    __pyx_t_7 = -1;
    if (__pyx_t_9 < 0) {
      __pyx_t_9 += __pyx_v_data.shape[0];
      if (unlikely(__pyx_t_9 < 0)) __pyx_t_7 = 0;
    } else if (unlikely(__pyx_t_9 >= __pyx_v_data.shape[0])) __pyx_t_7 = 0;
    if (__pyx_t_10 < 0) {
      __pyx_t_10 += __pyx_v_data.shape[1];
      if (unlikely(__pyx_t_10 < 0)) __pyx_t_7 = 1;
    } else if (unlikely(__pyx_t_10 >= __pyx_v_data.shape[1])) __pyx_t_7 = 1;
    if (unlikely(__pyx_t_7 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_7);
      __PYX_ERR(0, 8, __pyx_L1_error)
    }
    *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_data.data + __pyx_t_9 * __pyx_v_data.strides[0]) ) + __pyx_t_10 * __pyx_v_data.strides[1]) )) += (*((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_kick.data + __pyx_t_4 * __pyx_v_kick.strides[0]) ) + __pyx_t_5 * __pyx_v_kick.strides[1]) ) + __pyx_t_6 * __pyx_v_kick.strides[2]) )));
 ...
 */
    ...
    __pyx_t_7 = -1;
    if (__pyx_t_11 < 0) {
      __pyx_t_11 += __pyx_v_kick.shape[0];
      if (unlikely(__pyx_t_11 < 0)) __pyx_t_7 = 0;
    } else if (unlikely(__pyx_t_11 >= __pyx_v_kick.shape[0])) __pyx_t_7 = 0;
    if (__pyx_t_12 < 0) {
      __pyx_t_12 += __pyx_v_kick.shape[1];
      if (unlikely(__pyx_t_12 < 0)) __pyx_t_7 = 1;
    } else if (unlikely(__pyx_t_12 >= __pyx_v_kick.shape[1])) __pyx_t_7 = 1;
    if (__pyx_t_13 < 0) {
      __pyx_t_13 += __pyx_v_kick.shape[2];
      if (unlikely(__pyx_t_13 < 0)) __pyx_t_7 = 2;
    } else if (unlikely(__pyx_t_13 >= __pyx_v_kick.shape[2])) __pyx_t_7 = 2;
    if (unlikely(__pyx_t_7 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_7);
    ...
    __pyx_t_7 = -1;
    if (__pyx_t_14 < 0) {
      __pyx_t_14 += __pyx_v_idx.shape[0];
      if (unlikely(__pyx_t_14 < 0)) __pyx_t_7 = 0;
    } else if (unlikely(__pyx_t_14 >= __pyx_v_idx.shape[0])) __pyx_t_7 = 0;
    if (unlikely(__pyx_t_7 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_7);
      __PYX_ERR(0, 9, __pyx_L1_error)
    }
    __pyx_t_15 = (*((PY_LONG_LONG *) ( /* dim=0 */ (__pyx_v_idx.data + __pyx_t_14 * __pyx_v_idx.strides[0]) )));
    __pyx_t_16 = 1;
    __pyx_t_7 = -1;
    if (__pyx_t_15 < 0) {
      __pyx_t_15 += __pyx_v_data.shape[0];
      if (unlikely(__pyx_t_15 < 0)) __pyx_t_7 = 0;
    } else if (unlikely(__pyx_t_15 >= __pyx_v_data.shape[0])) __pyx_t_7 = 0;
    if (__pyx_t_16 < 0) {
      __pyx_t_16 += __pyx_v_data.shape[1];
      if (unlikely(__pyx_t_16 < 0)) __pyx_t_7 = 1;
    } else if (unlikely(__pyx_t_16 >= __pyx_v_data.shape[1])) __pyx_t_7 = 1;
    if (unlikely(__pyx_t_7 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_7);
      __PYX_ERR(0, 9, __pyx_L1_error)
    }
    *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_data.data + __pyx_t_15 * __pyx_v_data.strides[0]) ) + __pyx_t_16 * __pyx_v_data.strides[1]) )) += (*((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_kick.data + __pyx_t_11 * __pyx_v_kick.strides[0]) ) + __pyx_t_12 * __pyx_v_kick.strides[1]) ) + __pyx_t_13 * __pyx_v_kick.strides[2]) )));
  }
 ...
 */
  ...
  __PYX_XDEC_MEMVIEW(&__pyx_v_kick, 1);
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "crepel._memoryviewslice", /*tp_name*/
 ...
 *     for i in range(N):
 */
  __pyx_tuple__26 = PyTuple_Pack(6, __pyx_n_s_data, __pyx_n_s_idx, __pyx_n_s_kick, __pyx_n_s_size, __pyx_n_s_i, __pyx_n_s_N); if (unlikely(!__pyx_tuple__26)) __PYX_ERR(0, 5, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__26);
  __Pyx_GIVEREF(__pyx_tuple__26);
  __pyx_codeobj__27 = (PyObject*)__Pyx_PyCode_New(4, 0, 6, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__26, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_swellpy_crepel_pyx, __pyx_n_s_iterate, 5, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__27)) __PYX_ERR(0, 5, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initcrepel(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initcrepel(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_crepel(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_crepel(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_crepel(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'crepel' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_crepel(void)", 0);
 ...
 *     for i in range(N):
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_6crepel_1iterate, NULL, __pyx_n_s_crepel); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 5, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_iterate, __pyx_t_1) < 0) __PYX_ERR(0, 5, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
